 ...
 */
final class Version20240116130520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories_photos ADD image_id INT NOT NULL, ADD descriptons LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories_photos DROP image_id, DROP descriptons');
    }
}
